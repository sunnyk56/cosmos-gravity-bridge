...
type MsgDepositClaim struct {
	...
	CurrentValsetNonce uint64                                 `protobuf:"varint,3,opt,name=current_valset_nonce,json=currentValsetNonce,proto3" json:"current_valset_nonce,omitempty"`
...
func (m *MsgDepositClaim) GetCurrentValsetNonce() uint64 {
	if m != nil {
		return m.CurrentValsetNonce
	}
	return 0
}
...
func (m *MsgWithdrawClaim) GetCurrentValsetNonce() uint64 {
	if m != nil {
		return m.CurrentValsetNonce
	}
	return 0
...
func (m *MsgERC20DeployedClaim) GetCurrentValsetNonce() uint64 {
	if m != nil {
		return m.CurrentValsetNonce
	}
	return 0
...
func (m *MsgLogicCallExecutedClaim) GetCurrentValsetNonce() uint64 {
	if m != nil {
		return m.CurrentValsetNonce
	}
	return 0
...
var fileDescriptor_2f8523f2f6feb451 = []byte{
	...
	,
}
...
func (m *MsgDepositClaim) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CurrentValsetNonce != 0 {
		i = encodeVarintMsgs(dAtA, i, uint64(m.CurrentValsetNonce))
		i--
		dAtA[i] = 0x18
	}
	if m.BlockHeight != 0 {
...
func (m *MsgDepositClaim) Size() (n int) {
	...
	if m.CurrentValsetNonce != 0 {
		n += 1 + sovMsgs(uint64(m.CurrentValsetNonce))
	}
	l = len(m.TokenContract)
	if l > 0 {
		n += 1 + l + sovMsgs(uint64(l))
...
func (m *MsgDepositClaim) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CurrentValsetNonce", wireType)
			}
			m.CurrentValsetNonce = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowMsgs
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CurrentValsetNonce |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
